...
| **Delayed retire** | `retire_expire` countdown frees emptied sole pages later, on a generic-alloc cadence | emptied pages retired immediately; the sole page of a bin is kept | Keeping the sole page covers the common alloc/free/alloc cycle; the cadence is unported. |
...
purge, and abandoned-page reclaim — is ported faithfully and verified
